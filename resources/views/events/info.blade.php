...
<body>
    ...
    <header class="produtos-header">
        ...
        <nav class="nav-bar">
            <ul class="menu-nav">
                ...
                <li class="nav-menu-itens"><a href="/listService" class="links-menu-nav ">Produtos e Serviços</a></li>
                <li class="nav-menu-itens"><a href="/sobre" class="links-menu-nav atual-page">Sobre</a></li>
    ...
    <main>
        ...
        <section class="hero section container">
            <h1 class="big-title">Conheça um pouco da nossa historia</h1>

            <div class="hero-imgs">
                <img src="/img/image-content/gabriel-beaudry-70rHtD11NNk-unsplash.jpg" alt="" class="img-1">
                <img src="/img/image-content/christina-wocintechchat-com-faEfWCdOKIg-unsplash.jpg" alt=""
                    class="img-2">
                <img src="/img/image-content/alesia-kazantceva-XLm6-fPwK5Q-unsplash.jpg" alt="" class="img-3">
            </div>
        ...
        <section class="section section-2 container">
            <div class="section-data">
                <div class="section-text">
                    <h2 class="section-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </h2>
                ...
                <div class="section-img">
                    <img src="/img/image-content/austin-distel-wawEfYdpkag-unsplash.jpg" alt="">
                </div>
            </div>
        </section>
    ...
    <button type="button" id="wtz-button" class="btn2 btn-wtz">
        <a href="https://wa.me/558136341126" target="_blank">
          <img src="/icons/logo-whatsapp.svg" alt=""
