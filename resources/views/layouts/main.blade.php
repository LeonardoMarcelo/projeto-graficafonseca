...
<body>
    ...
    <header>
        ...
        <nav class="nav-bar">
            <ul class="menu-nav">
                <li class="nav-menu-itens"><a href="/" class="links-menu-nav atual-page">Início</a></li>
    ...
    <button type="button" id="wtz-button" class="btn2 btn-wtz">
        <a href="http://api.whatsapp.com/send?1=pt_BR&phone=558136341126" target="_blank">
            <img src="/icons/logo-whatsapp.svg" alt="" class="qr-icon">
        </a>
